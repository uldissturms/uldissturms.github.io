...
\personalinfo{%
  % Not all of these are required!
    % You can add your own with \printinfo{symbol}{detail}
      ...
      \phone{+4407456193049}
      \mailaddress{3305 Sky View Tower}
      \location{London, UK}
...
\cvevent{NodeJS Developer (Contract)}{SapientRazorfish}{Jan 2018}{London, UK}
\begin{itemize}
...
\divider
\cvevent{DBaaS Engineer (Contract)}{Barclays}{Mar 2017 -- Nov 2017}{London, UK}
\begin{itemize}
...
\cvevent{Senior Software Engineer}{R3PI}{Oct 2016 -- Feb 2017}{London, UK}
\begin{itemize}
...
\cvevent{Software Developer (Contract)}{Digiterre}{Apr 2016 -- Oct 2016}{London, UK}
\begin{itemize}
